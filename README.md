...
Макет реализовал только частично. Мне было очень интересно реализовать момент, где при наведении не просто увеличение картинки, но и появление новых элементов.
